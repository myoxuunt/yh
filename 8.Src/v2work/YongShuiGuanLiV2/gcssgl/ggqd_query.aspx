<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ggqd_query.aspx.cs" Inherits="YongShuiGuanLiV2.gcssgl.ggqd_query" Title="无标题页" %>
...
<table style="BORDER-RIGHT: #d6d3ce 1px solid; BORDER-TOP: #d6d3ce 2px solid; BORDER-LEFT: #d6d3ce 1px solid; BORDER-BOTTOM: #d6d3ce 1px solid"
				...
				<tr>
					<td style="HEIGHT: 100%" bgColor="#f7f3ef"><iewc:tabstrip id="TabStrip1" style="BORDER-TOP: #666666 1px solid; Z-INDEX: 101; LEFT: 336px; PADDING-TOP: 3px; BORDER-BOTTOM: #d6d3ce 3px solid; BACKGROUND-COLOR: #f7f3ef"
							...
							TargetID="MultiPage1" Width="500px" Height="100%">
							<iewc:Tab Text="渠道基础信息" TargetID="Page11"></iewc:Tab>
							<iewc:Tab Text="渠道防渗信息" TargetID="Page21"></iewc:Tab>
							<iewc:Tab Text="渠道技术参数" TargetID="Page31"></iewc:Tab>
							<iewc:Tab Text="渠道险工险段" TargetID="Page41"></iewc:Tab>
						</iewc:tabstrip></td>
				</tr>
			</table>
					...
					<td>
						<iewc:MultiPage id="MultiPage1" runat="server" Width="996px" height="750px">
							<iewc:PageView id="Page11">
								<iframe name="ifrmReport" align="middle" src="qdxx.aspx" frameBorder="0" width="100%" height="100%">
								</iframe>
							</iewc:PageView>
							<iewc:PageView id="Page21">
								<iframe name="ifrmReport1" align="middle" src="qdfs.aspx" frameBorder="0" width="100%" height="100%">
								</iframe>
							</iewc:PageView>
							<iewc:PageView id="Page31">
								<iframe name="ifrmReport1" align="middle" src="qdjscs.aspx" frameBorder="0" width="100%"
									height="100%"></iframe>
							</iewc:PageView>
							<iewc:PageView id="Page41">
								<iframe name="ifrmReport1" align="middle" src="qdxgxd.aspx" frameBorder="0" width="100%"
									height="100%"></iframe>
							</iewc:PageView>
						</iewc:MultiPage>
					</td>
