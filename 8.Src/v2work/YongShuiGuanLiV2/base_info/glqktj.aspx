<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="glqktj.aspx.cs" Inherits="YongShuiGuanLiV2.base_info.glqktj" %>
				...
				<tr>
					<td><FONT face="宋体">
							<table cellSpacing="0" cellPadding="0" width="100%">
								<tr class="title">
									<td align="center" colSpan="2"><label style="font-size: 15px; font-weight: bold;">管理情况统计</label></td>
								</tr>
							</table>
										...
										AllowPaging="True" PageSize="15" AutoGenerateColumns="False" 
                                         CellPadding="4" BackColor="White" onitemcommand="DataGrid1_ItemCommand" 
											...
											<Columns>
												...
												<asp:BoundColumn DataField="glqk_id" Visible="False"></asp:BoundColumn>
