<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gcsj_new.aspx.cs" Inherits="YongShuiGuanLiV2.base_info.gcsj_new" %>
				...
				<tr>
					<td>
						<table cellSpacing="0" cellPadding="0" width="100%">
							<tr class="title">
								<td align="center" colSpan="2"><label style="font-size: 15px; font-weight: bold;">工程数据文件上传</label></td>
							</tr>
							<tr>
