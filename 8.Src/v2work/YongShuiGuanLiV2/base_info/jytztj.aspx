<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="jytztj.aspx.cs" Inherits="YongShuiGuanLiV2.base_info.jytztj" %>
				...
				<tr>
					<td><FONT face="宋体">
							<table cellSpacing="0" cellPadding="0" width="100%">
								<tr class="title">
									<td align="center" colSpan="2"><label style="font-size: 15px; font-weight: bold;">经营投资情况统计</label></td>
								</tr>
							</table>
										...
										AllowPaging="True" PageSize="15" AutoGenerateColumns="False" 
                                         CellPadding="4" BackColor="White" onitemcommand="DataGrid1_ItemCommand" 
											...
											<Columns>
												...
												<asp:BoundColumn DataField="jytz_id" Visible="False"></asp:BoundColumn>
