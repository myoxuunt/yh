<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dcxx.aspx.cs" Inherits="YongShuiGuanLiV2.gcssgl.dcxx" %>
...
<body>
    ...
    <table borderColor="#7ab4ff" cellSpacing="0" cellPadding="0" width="100%" border="1">
				<tr>
					<td>
							<table cellSpacing="0" cellPadding="0" width="100%">
								<tr class="title">
									<td align="center" colSpan="2"><label style="font-size: 15px; font-weight: bold;">渡槽信息查询</label></td>
								</tr>
							</table>
							<table width="100%">
								<tr>
				...
				<tr>
					<td width="100%"><asp:datagrid id="DataGrid1" runat="server" Width="100%" 
							...
							<Columns>
								...
								<asp:BoundColumn DataField="渡槽名称" HeaderText="渡槽名称">
								...
								<asp:BoundColumn DataField="渡槽长度（米）" HeaderText="渡槽长度（米）">
								<HeaderStyle Font-Bold="True" Wrap="False" Width="10%"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
			...
			<table width="100%" style="height: 176px">
				
					<tr class="style1">
						<td Width="50%">渡槽名称：<asp:label id="dcmc" runat="server" ></asp:label></td>
						<td>所属渠道：<asp:label id="ssqd" runat="server"></asp:label></td>
					</tr>
					<tr>
						<td Width="50%">起始桩号：<asp:label id="qszh" runat="server"></asp:label></td>
						<td>基础埋深（米）：<asp:label id="jcms" runat="server"></asp:label></td>
					</tr>
					<tr class="style1">
						<td Width="50%">断面类型：<asp:label id="dmlx" runat="server"></asp:label></td>
						<td>渡槽孔数（孔）：<asp:label id="dcks" runat="server"></asp:label></td>
					</tr>
					<tr>
						<td Width="50%">渡槽长度（米）：<asp:label id="dccd" runat="server"></asp:label></td>
						<td>渡槽高度（米）：<asp:label id="dcgd" runat="server"></asp:label></td>
					</tr>
					<tr class="style1">
						<td Width="50%">渡槽宽度（米）：<asp:label id="dckd" runat="server"></asp:label></td>
						<td>渡槽半径（米）：<asp:label id="dcbj" runat="server"></asp:label></td>
					</tr>
					<tr>
						<td Width="50%">设计流量（立方米/秒）：<asp:label id="sjll" runat="server"></asp:label></td>
						<td>材料类型：<asp:label id="cllx" runat="server"></asp:label></td>
					</tr>
					<tr class="style1">
