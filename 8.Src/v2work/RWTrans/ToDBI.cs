...
namespace RWTrans 
{
    public class ToDBI : DBIBase 
    {
        ...
        internal void GetToInfo(string fromName, string type, 
        ...
        /// <param name="p"></param>
        /// <returns></returns>
        internal DateTime GetLastDateTime(int deviceID ,DataType dataType)
        {
        ...
        internal void InsertRain(int ToDeviceID, DateTime dt, float rain)
        {
            string sql = string.Format(
        ...
        #region InsertWater
        internal void InsertWater(int ToDeviceID, DateTime dt, float wl, float instantFlux)
        {
