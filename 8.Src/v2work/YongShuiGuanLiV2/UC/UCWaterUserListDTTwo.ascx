<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="UCWaterUserListDTTwo.ascx.cs"
    Inherits="YongShuiGuanLiV2.UC.UCWaterUserListDTTwo" %>
<div>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td>
                        <asp:DropDownList ID="ddlOrganization" runat="server" OnSelectedIndexChanged="ddlOrganization_SelectedIndexChanged"
                            AutoPostBack="True">
                        </asp:DropDownList>
                    </td>
                    <td>
                ...
                <tr>
                    ...
                    <td>
                        <asp:CheckBoxList ID="cblWaterUserList" runat="server">
                        </asp:CheckBoxList>
                    </td>
                    <td>
                        &nbsp;
