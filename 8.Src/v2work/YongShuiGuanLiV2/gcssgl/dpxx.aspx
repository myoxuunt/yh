<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dpxx.aspx.cs" Inherits="YongShuiGuanLiV2.gcssgl.dpxx" %>
...
<body>
    ...
    <table borderColor="#7ab4ff" cellSpacing="0" cellPadding="0" width="100%" border="1">
				<tr>
					<td>
							<table cellSpacing="0" cellPadding="0" width="100%">
								<tr class="title">
									<td align="center" colSpan="2"><label style="font-size: 15px; font-weight: bold;">陡坡信息查询</label></td>
								</tr>
							</table>
							<table width="100%">
								<tr>
				...
				<tr>
					<td width="100%"><asp:datagrid id="DataGrid1" runat="server" Width="100%" 
							...
							<Columns>
								...
								<asp:BoundColumn DataField="陡坡名称" HeaderText="陡坡名称">
								...
								<asp:BoundColumn DataField="陡坡长度（米）" HeaderText="陡坡长度（米）">
								<HeaderStyle Font-Bold="True" Wrap="False" Width="10%"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
								<asp:BoundColumn DataField="陡坡形式" HeaderText="陡坡形式">
								<HeaderStyle Font-Bold="True" Wrap="False" Width="10%"></HeaderStyle>
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
								</asp:BoundColumn>
			...
			<table width="100%" style="height: 110px">
					<tr class="style1">
						<td Width="50%">陡坡名称：<asp:label id="qsmc" runat="server" ></asp:label></td>
						<td>所属渠道：<asp:label id="dlwz" runat="server"></asp:label></td>
					</tr>
					<tr>
						<td Width="50%">起始桩号：<asp:label id="gclx" runat="server"></asp:label></td>
						<td>陡坡长度（米）：<asp:label id="sqsy" runat="server"></asp:label></td>
					</tr>
					<tr class="style1">
						<td Width="50%">陡坡形式：<asp:label id="qsll" runat="server"></asp:label></td>
						<td>断面类型：<asp:label id="qszc" runat="server"></asp:label></td>
					</tr>
					<tr>
