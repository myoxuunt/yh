...
namespace YeHeCommuniServer
{
    ...
    public class DevieFormaulCollectionMapCollection : Collection<DeviceFormulaCollectionMap>
    {
        ...
        internal void DeleteFormula(Formula formula)
        {
            foreach (DeviceFormulaCollectionMap item in this)
            {
        ...
        /// <param name="device"></param>
        /// <returns></returns>
        internal FormulaCollection GetFormulaCollection(int deviceID)
        {
            foreach (DeviceFormulaCollectionMap item in this)
            {
        ...
        /// <param name="device"></param>
        /// <param name="formula"></param>
        internal void AddFormula(int deviceID, Formula formula)
        {
            foreach (DeviceFormulaCollectionMap item in this)
            {
                if (item.DeviceID == deviceID)
