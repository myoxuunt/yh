...
namespace CReportDll.comReport.newRep
{
	...
	public	System.Windows.Forms.DataGrid dataGrid4;
		...
		public bool bAllBLand=true;

		public string m_strTitle1="";
		public string m_strTitle2="";
		public string m_strTitle3="";
		public string m_strTitle4="";
		...
		private void InitializeComponent()
		{
			...
			// btnPrint
			// 
			this.btnPrint.Location = new System.Drawing.Point(120, 176);
			...
			// btnExit
			// 
			this.btnExit.Location = new System.Drawing.Point(192, 176);
			...
			this.dgPrint.Location = new System.Drawing.Point(0, 152);
			...
			this.checkBox4.Size = new System.Drawing.Size(224, 24);
		...
		private void frmPrint_Load(object sender, System.EventArgs e)
		{
			try
			{
				...
				if(this.bAllBLand)
				{
					...
					string strTitle=xDoc.DocumentElement.SelectSingleNode("./report[@name='tb1']").Attributes.GetNamedItem("title").Value.Trim() ;
				...
				{
					this.checkBox1.Text=this.m_strTitle1;
					this.checkBox2.Text=this.m_strTitle2;
					this.checkBox3.Text=this.m_strTitle3;
					this.checkBox4.Text=this.m_strTitle4;
				}
