<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qdjscs.aspx.cs" Inherits="YongShuiGuanLiV2.gcssgl.qdjscs" %>
				...
				<tr>
					<td><FONT face="宋体">
							<table cellSpacing="0" cellPadding="0" width="100%">
								<tr class="title">
									<td align="center" colSpan="3"><label style="font-size: 15px; font-weight: bold;">渠道技术参数查询</label></td>
								</tr>
							</table>
							<table width="100%">
								<tr>
										...
										AllowPaging="True" PageSize="15" AutoGenerateColumns="False" 
                                         CellPadding="4" BackColor="White" onitemcommand="DataGrid1_ItemCommand" 
											...
											<Columns>
												...
												<HeaderStyle Font-Bold="True" Wrap="False" Width="18%"></HeaderStyle>
												</asp:BoundColumn>
												...
												<asp:BoundColumn DataField="渠段长度（千米）" HeaderText="渠段长度（千米）" >
												<HeaderStyle Font-Bold="True" Wrap="False" Width="18%"></HeaderStyle>
												</asp:BoundColumn>
							...
							<table cellSpacing="0" cellPadding="0" width="100%" border="0" style="height:242px">
								<TBODY>
									<tr class="style1">
										...
										<td align="left">渠段长度（千米）：
											<asp:label id="qdcd" runat="server"></asp:label></td>
									</tr>
									<tr>
										<td width="50%">起始桩号：
									...
									<tr class="style1">
										<td width="50%">断面形式：<asp:label id="dmxs" runat="server"></asp:label></td>
										<td>设计流量(立方米/秒)：<asp:label id="sjll" runat="server"></asp:label></td>
									</tr>
									<tr>
										<td width="50%">加大流量(立方米/秒)：<asp:label id="jdll" runat="server"></asp:label></td>
										<td>设计流速(立方米/秒)：<asp:label id="sjls" runat="server"></asp:label></td>
									</tr>
									<tr class="style1">
										<td width="50%">设计水深(米)：<asp:label id="sjss" runat="server"></asp:label></td>
										<td>渠道水利用系数（%）：<asp:label id="qdslyxs" runat="server"></asp:label></td>
									</tr>
									<tr>
										<td width="50%">临界不冲流速（立方米/秒）：<asp:label id="ljbcls" runat="server"></asp:label></td>
										<td>临界不淤流速（立方米/秒）：<asp:label id="ljbyls" runat="server"></asp:label></td>
									</tr>
									<tr class="style1">
