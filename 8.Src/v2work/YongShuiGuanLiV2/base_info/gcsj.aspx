<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="gcsj.aspx.cs" Inherits="YongShuiGuanLiV2.base_info.gcsj" Title="无标题页" %>
...
<table style="BORDER-RIGHT: #d6d3ce 1px solid; BORDER-TOP: #d6d3ce 2px solid; BORDER-LEFT: #d6d3ce 1px solid; BORDER-BOTTOM: #d6d3ce 1px solid"
				...
				<tr>
					<td style="HEIGHT: 100%" bgColor="#f7f3ef"><iewc:tabstrip id="TabStrip1" style="BORDER-TOP: #666666 1px solid; Z-INDEX: 101; LEFT: 336px; PADDING-TOP: 3px; BORDER-BOTTOM: #d6d3ce 3px solid; BACKGROUND-COLOR: #f7f3ef"
							...
							<iewc:Tab Text="工程数据统计" TargetID="Page11"></iewc:Tab>
							<iewc:Tab Text="工程数据新建" TargetID="Page21"></iewc:Tab>
						</iewc:tabstrip></td>
				</tr>
			</table>
					...
					<td>
						<iewc:MultiPage id="MultiPage1" runat="server" Width="996px" height="750px">
							<iewc:PageView id="Page11">
								<iframe name="ifrmReport" align="middle" src="gcsjtj.aspx" frameBorder="0" width="100%"
									height="100%"></iframe>
							</iewc:PageView>
							<iewc:PageView id="Page21">
								<iframe name="ifrmReport1" align="middle" src="gcsj_new.aspx" frameBorder="0" width="100%"
									height="100%"></iframe>
							</iewc:PageView>
						</iewc:MultiPage>
					</td>
